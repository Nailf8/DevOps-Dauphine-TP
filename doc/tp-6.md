...
6. Rendez-vous sur https://console.cloud.google.com/sql/instances/main-instance/databases. Quelles sont les base de données présentes sur votre instance `main-instance` ? Quels sont les types ?
   Il ya 5 bases de données présentes :
   - information_schema	de type system		
   - mysql de type system		
   - performance_schema de type system		
   - sys de type	system		
   - wordpress de type user
...
3. Lancer l'image docker et ouvrez un shell à l'intérieur de votre container:
